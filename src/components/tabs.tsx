...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center text-muted-foreground rounded-none",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "text-secondary hover:text-neutral-900",
      ...
      "after:bg-transparent after:rounded-t-[10px]",
      "data-[state=active]:after:bg-neutral-900",
